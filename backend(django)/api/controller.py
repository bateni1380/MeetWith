        ...
        if (order=='past' and time['date']<date) or (order=='present' and time['date']==date) or (order=='future' and time['date']>date):
            ...
            for meet in meets:
                ...
                output.append({'meeting_id':meet['id'], 
                               ...
                               'date':{'year':time['date'].year, 'month':time['date'].month, 'day':time['date'].day},
                               'start_time':{"hour":time['start_time'].hour, "minute":time['start_time'].minute, "second":time['start_time'].second},
                               'end_time':{"hour":time['end_time'].hour, "minute":time['end_time'].minute, "second":time['end_time'].second},
