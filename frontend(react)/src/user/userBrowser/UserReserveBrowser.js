    ...
    return(
        <div dir="rtl" style={{margin : "0px 0px 100px 0px"}}>
            <Modal
                ...
                <Modal.Footer>
                    <Stack gap={1}>
                        <Button variant={props.color.color1} onClick={functionEndReserve}>تایید</Button>
             ...
             <Container>
                ...
                <Card.Body>
                    <Stack>
                        <ButtonGroup vertical size="" style={{margin : "10px 5px 10px 5px"}}>
                            <Button variant={day==0 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,0)}}>
                                {dateFarsi(timeTable.days[0].date.year,timeTable.days[0].date.month,timeTable.days[0].date.day)}</Button>
                            <Button variant={day==1 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,1)}}> 
                                {dateFarsi(timeTable.days[1].date.year,timeTable.days[1].date.month,timeTable.days[1].date.day)}</Button>
                            <Button variant={day==2 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,2)}}> 
                                {dateFarsi(timeTable.days[2].date.year,timeTable.days[2].date.month,timeTable.days[2].date.day)}</Button>
                            <Button variant={day==3 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,3)}}> 
                                {dateFarsi(timeTable.days[3].date.year,timeTable.days[3].date.month,timeTable.days[3].date.day)}</Button>
                            <Button variant={day==4 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,4)}}>
                                {dateFarsi(timeTable.days[4].date.year,timeTable.days[4].date.month,timeTable.days[4].date.day)}</Button>
                            <Button variant={day==5 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,5)}}> 
                                {dateFarsi(timeTable.days[5].date.year,timeTable.days[5].date.month,timeTable.days[5].date.day)}</Button>
                            <Button variant={day==6 ? props.color.color2 : props.color.color1} onClick={(e)=>{functionDropDown(e,6)}}> 
                                {dateFarsi(timeTable.days[6].date.year,timeTable.days[6].date.month,timeTable.days[6].date.day)}</Button>
                        </ButtonGroup>
